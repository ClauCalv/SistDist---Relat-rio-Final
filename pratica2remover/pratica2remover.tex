...
\begin{minipage}{\textwidth}
  \hspace{-1em}
  \centering
  \lstinputlisting[language=Java]{pratica2remover/codigos/serialization/SerialObjectServer.java}
...
\begin{minipage}{\textwidth}
  \hspace{-1em}
  \centering
  \lstinputlisting[language=Java]{pratica2remover/codigos/serialization/SerialObjectClient.java}
...
\begin{minipage}{\textwidth}
    \hspace{-1em}
    \centering
    \includegraphics[scale=.35]{pratica2remover/prints/serial_server.PNG}
    \hspace{1em}
    \includegraphics[scale=.35]{pratica2remover/prints/serial_client.PNG}
